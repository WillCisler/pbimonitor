...
function Wait-On429Error
{
    ...
    try {
        ...
        if ($errorText -like "*HttpRequestException*" -and ($errorText -like "*429 (Too Many Requests)*" -or $errorText -like "*Response status code does not indicate success: 429*" -or $errorText -like "*You have exceeded the amount of requests allowed in the current time frame*")) {
